...
import 'package:ppkd_b2/meet_16/database/db_helper.dart';
import 'package:ppkd_b2/meet_16/model/user_model.dart';
    ...
    return TextFormField(
      ...
      validator: (value) {
        if (value == null || value.isEmpty) {
          return 'please enmter some text ';
        }
        return null;
      },

...
class HogwartsStaffScreen extends StatefulWidget {
  // Ubah menjadi StatefulWidget
  const HogwartsStaffScreen({super.key});

  @override
  State<HogwartsStaffScreen> createState() => _HogwartsStaffScreenState();
}

class _HogwartsStaffScreenState extends State<HogwartsStaffScreen> {
  ...
  // Helper untuk mendapatkan warna berdasarkan House (sama seperti di file lain)
            ...
            if (snapshot.connectionState == ConnectionState.waiting) {
              ...
              return Center(
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      'Failed to load staff: ${snapshot.error}',
              ...
              return ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  final String? staffHouseName = _getEnumValue(
                    user.house,
                    houseValues,
                  );
                  final Color staffHouseColor = _getHouseColor(
                    ...
                    child: ListTile(
                      ...
                      title: Text(
                        ...
                        style: TextStyle(
                          ...
                          fontSize: 18,
                          color:
                              staffHouseColor, // Warna title berdasarkan House
                        ),
                      ),
                      subtitle: Text(
                        'House: ${staffHouseName ?? 'N/A'} | Species: ${user.species ?? 'N/A'}',
                        style: TextStyle(
                      ...
                      leading: CircleAvatar(
                        radius: 30,
                        backgroundColor: staffHouseColor.withOpacity(
                          0.2,
                        ...
                        child:
                            user.image == null || user.image!.isEmpty
                                ? Icon(
                                  ...
                                  size: 30,
                                  color:
                                      staffHouseColor, // Warna ikon jika tidak ada gambar
                                )
                                : null,
                      ),
                      trailing: Icon(
                        ...
                        size: 16,
                        color: staffHouseColor, // Warna ikon trailing
                      ),
                      onTap: () {
                        Navigator.push(
                          context,
